...
class Ingredient(models.Model):
    ...
    name = models.CharField(max_length=255, verbose_name="Ingredient name", unique=True)
...
class Tag(models.Model):
    ...
    color = models.CharField(
        max_length=100, blank=True, verbose_name="Tag's color", default=""
    )
    nice_name = models.CharField(
        max_length=255, blank=True, verbose_name="Nice english name for tag", default=""
    )
...
class Recipe(models.Model):
    ...
    tags = models.ManyToManyField(
        Tag, related_name="recipes", verbose_name="Recipe's tags"
    )
    ...
    image = models.ImageField(
        upload_to="recipes/", blank=True, verbose_name="Recipe's Image", default=""
    )
    slug = AutoSlugField(
        populate_from="name",
        allow_unicode=True,
...
class Amount(models.Model):
    ...
    recipe = models.ForeignKey(
        Recipe, on_delete=models.CASCADE, related_name="amounts", verbose_name="Recipe"
    )
